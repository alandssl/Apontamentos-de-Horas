                ...
                <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Image
                            ...
                            width={140}
                            height={50}
                            className="h-10 w-auto object-contain drop-shadow-[0_2px_4px_rgba(0,0,0,0.05)]"
                            priority
                        />
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="h-10 w-10 flex items-center justify-center shrink-0 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800 shadow-sm">
                            ...
                            <form action={logoutAction}>
                                <Button
                                    ...
                                    size="icon"
                                    type="submit"
                                    className="h-10 w-10 flex items-center justify-center shrink-0 rounded-full bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-800/50 shadow-sm hover:bg-rose-100 dark:hover:bg-rose-900/40 hover:text-rose-700 dark:hover:text-rose-300 transition-colors"
                                >
